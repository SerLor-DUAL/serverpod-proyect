...
--
-- Class PasswordOptions as table password_options
--
...
--
-- Class UsersRegistry as table users_registry
--
...
WITH upsert AS (
    ...
    SET "version" = '20240724180357124', "timestamp" = now()
    WHERE "module" = 'proyect'
    RETURNING *
)
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    SELECT 'proyect', '20240724180357124', now()
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    SELECT 'serverpod_auth', '20240520102713718', now()
    WHERE NOT EXISTS (SELECT 1 FROM upsert);
