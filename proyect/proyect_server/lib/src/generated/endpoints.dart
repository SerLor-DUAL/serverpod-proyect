...
import '../endpoints/afilnet/afilnet_sms_endpoint.dart' as _i2;
import '../endpoints/afilnet/afilnet_whatsapp_endpoint.dart' as _i3;
import '../endpoints/contact/contacts_endpoint.dart' as _i4;
import '../endpoints/todolist/tasks_endpoint.dart' as _i5;
import '../endpoints/users/authenticated_endpoint.dart' as _i6;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'afilnetWhatsApp': _i3.AfilnetWhatsAppEndpoint()
        ..initialize(
          server,
          'afilnetWhatsApp',
          null,
        ),
      'contact': _i4.ContactEndpoint()
        ..initialize(
          server,
          'contact',
          null,
      ...
      'authenticated': _i6.AuthenticatedEndpoint()
        ..initialize(
          server,
          'authenticated',
          null,
        ),
      'passwordGenerator': _i7.PasswordGeneratorEndpoint()
        ..initialize(
          server,
          'passwordGenerator',
          null,
        ),
      'passwordOptions': _i8.PasswordOptionsEndpoint()
        ..initialize(
          server,
          'passwordOptions',
          null,
        ),
      'usersRegistry': _i9.UsersRegistryEndpoint()
        ..initialize(
          server,
          'usersRegistry',
          null,
        ...
        'sendMessage': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['afilnetWhatsApp'] as _i3.AfilnetWhatsAppEndpoint)
                  .sendMessage(
            session,
            params['destination'],
            params['message'],
        ...
        'addContact': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['contact'] as _i4.ContactEndpoint).addContact(
            session,
            params['contact'],
          ),
        ),
        'addListOfContacts': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['contact'] as _i4.ContactEndpoint).addListOfContacts(
            session,
            params['contacts'],
          ),
        ),
        'findById': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['contact'] as _i4.ContactEndpoint).findById(
            session,
            params['contactID'],
          ),
        ),
        'getEveryContactByUser': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['contact'] as _i4.ContactEndpoint)
        ...
        'isContactOnList': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['contact'] as _i4.ContactEndpoint).isContactOnList(
            session,
            params['phoneNumber'],
            params['userID'],
          ),
        ...
        'updateContact': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['contact'] as _i4.ContactEndpoint).updateContact(
            session,
            params['contact'],
          ),
        ),
        'deleteContact': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['contact'] as _i4.ContactEndpoint).deleteContact(
            session,
            params['contact'],
          ),
        ),
        ...
        'addTask': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint).addTask(
            session,
            params['task'],
          ),
        ),
        'addListOfTasks': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint).addListOfTasks(
            session,
            params['tasks'],
          ),
        ),
        'findById': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint).findById(
            session,
            params['taskID'],
          ),
        ),
        'getEveryTaskByUser': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint).getEveryTaskByUser(
            session,
            params['userID'],
          ),
        ),
        'getEveryTaskByDeadLineASC': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint)
        ...
        'updateTask': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint).updateTask(
            session,
            params['task'],
          ),
        ),
        'toogleComplete': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint).toogleComplete(
            session,
            params['task'],
          ),
        ),
        'deleteTask': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint).deleteTask(
            session,
            params['task'],
          ),
        ),
        'deleteMultipleTasks': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['tasks'] as _i5.TasksEndpoint).deleteMultipleTasks(
            session,
            params['tasks'],
          ),
        ),
        ...
        'logout': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['authenticated'] as _i6.AuthenticatedEndpoint)
                  .logout(session),
        ),
        ...
        'createPassword': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['passwordGenerator'] as _i7.PasswordGeneratorEndpoint)
                  .createPassword(
            session,
            params['options'],
        ...
        'getOptions': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['passwordOptions'] as _i8.PasswordOptionsEndpoint)
                  .getOptions(
            session,
            params['optionsID'],
          ),
        ...
        'getAllUsers': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['usersRegistry'] as _i9.UsersRegistryEndpoint)
                  .getAllUsers(session),
        ),
        ...
        'login': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['usersRegistry'] as _i9.UsersRegistryEndpoint).login(
            session,
            params['username'],
            params['password'],
          ),
